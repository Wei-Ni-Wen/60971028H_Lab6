...
def in_range(enemy, tower): # set enemy and tower range
    x1, y1 = enemy.rect.center  # get enemy's point
    x2, y2 = tower.rect.center  # get tower's point
    # compute distance between enemy and tower
...
class Snipe(AttackStrategy):	# one shot one kill
