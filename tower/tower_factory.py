...
class Vacancy:  # if click button, return button's name
...
class Tower:
    ...
    @classmethod
    def RapidTest(cls, x, y):	# set tower RapidTest 's attack strategy
    ...
    @classmethod
    def Alcohol(cls, x, y):	# set tower Alcohol 's attack strategy
    ...
    @classmethod
    def PCR(cls, x: int, y: int):	# set tower PCR 's attack strategy
        """
